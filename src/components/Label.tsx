...
const RootStyle = styled('span')<{ ownerState: { color: LabelColor, variant: LabelVariant } }>(({ theme, ownerState }) => {
    ...
    ...(color !== 'default'
      ...
      : {
          ...
          ...(variant === 'ghost' && {
            ...
            backgroundColor: (theme.palette.grey as any)[500_16],
          }),
        }),
  };
});
...
export default function Label({ children, color = 'default', variant = 'ghost', startIcon, endIcon }: LabelProps) {
  const style = {
    width: 16,
    height: 16,
